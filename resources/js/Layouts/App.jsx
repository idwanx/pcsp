        ...
        <div className="min-h-screen bg-gray-100 tracking-wide">
            {
                (() => {
                    if(route().current('profile.edit')) {
                        return null
                    } else if (route().current('password.edit')) {
                        return null
                    } else {
                        return (
                            <Navbar />
            ...
            <main>
                <div className="mx-auto max-w-screen-2xl py-6 sm:px-2 lg:px-6 2xl:px-6">{children}</div>
            </main>
            <footer className="mt-6 lg:mt-10 border-t border-gray-300">
                <div className="p-6">
                    <div className="text-center">
                        <span className="block text-sm text-center text-gray-400">
                            Created ©{new Date().getFullYear()} by PCSP ™. <br />
