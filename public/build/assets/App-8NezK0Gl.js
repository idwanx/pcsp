...
`,vt="0%{opacity:0;} 100%{opacity:1;}",bt="0%{opacity:1;} 100%{opacity:0;}",wt=R("div")`
  display: flex;
  align-items: center;
  background: #fff;
  color: #363636;
